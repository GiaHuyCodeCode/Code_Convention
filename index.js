...
//=============================================ISSUE 7: Poor Comments ================================================================================

// Cộng tất cả các phần tử và chia cho 2  <-- Lỗi: comment sai
function halfAverage(arr){
    let sum=0;
    for(let i=0;i<arr.length;i++){sum+=arr[i]}
    return sum/2; // thực ra không phải average
}

//============================================================CLEAN CODE================================================================================

// Hàm thực sự tính trung bình
function calculateAverage(arr){
    let sum = calculateArraySum(arr);
